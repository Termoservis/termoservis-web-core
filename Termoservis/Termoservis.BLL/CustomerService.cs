...
namespace Termoservis.BLL
{
    ...
    public class CustomerService : ICustomerService
    {
        ...
        {
            this.customersRepository = customersRepository ?? throw new ArgumentNullException(nameof(customersRepository));
            this.telephoneNumbersRepository = telephoneNumbersRepository ?? throw new ArgumentNullException(nameof(telephoneNumbersRepository));
            this.customerDevicesRepository = customerDevicesRepository ?? throw new ArgumentNullException(nameof(customerDevicesRepository));
