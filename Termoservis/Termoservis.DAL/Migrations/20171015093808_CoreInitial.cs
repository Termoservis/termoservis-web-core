...
namespace Termoservis.DAL.Migrations
{
    public partial class CoreInitial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkItems_Workers_WorkerId",
                        column: x => x.WorkerId,
            ...
            migrationBuilder.CreateTable(
                name: "WorkItemCustomerDeviceRelation",
                columns: table => new
                {
                    CustomerDeviceId = table.Column<long>(type: "bigint", nullable: false),
                    WorkItemId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkItemCustomerDeviceRelation", x => new { x.CustomerDeviceId, x.WorkItemId });
                    table.ForeignKey(
                        name: "FK_WorkItemCustomerDeviceRelation_CustomerDevices_CustomerDeviceId",
                        column: x => x.CustomerDeviceId,
                        principalTable: "CustomerDevices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkItemCustomerDeviceRelation_WorkItems_WorkItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkItemCustomerDeviceRelation_WorkItemId",
                table: "WorkItemCustomerDeviceRelation",
                column: "WorkItemId");
